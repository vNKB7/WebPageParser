...
public class ModelSet {
	...
	List<CQJT_ZHAOBIAO_Model> model_set = new ArrayList<CQJT_ZHAOBIAO_Model>();
	...
	public int get_sim_model(String html) {
		Document doc = CQJT_ZHAOBIAO_Model.preParse(html);
		CQJT_ZHAOBIAO_Model sim_model = null;
		double min_dis = Double.MAX_VALUE;
		for (CQJT_ZHAOBIAO_Model m : model_set) {
	...
	public boolean add_model(String html) {
		...
		if (min_dis == 0) {
			...
			model_set.add(new CQJT_ZHAOBIAO_Model(doc));
			return true;
		}
	}
